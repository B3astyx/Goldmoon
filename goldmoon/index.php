...
<header>
  ...
  <img src="goldmoonlogo.png" alt="GoldmoonLogo" class="logo">
	<nav class="site-nav">
      ...
      <li><a class="nav-link" href="https://twitter.com/GoldmoonInc" target="_blank"><i class="fa fa-dollar-sign site-nav--icon"></i>Twitter</a></li>
      <li><a class="nav-link" href="login.php"><i class="fa fa-envelope site-nav--icon"></i>Login/Signup</a></li>
		</ul>
	</nav>
...
<section class="home-hero parallax-background">
    ...
    <h1 class="title title-hero"> <strong>Goldmoon</strong> <span>The Best Site</span>
		...
		<a href="loggedinindex.php" onclick="main()" class="button  button-accent">Enter</a>
	</div>
</section>
